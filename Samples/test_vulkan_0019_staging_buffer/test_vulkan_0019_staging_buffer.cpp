...
public:
    Application()
    {
        ...
        this->vertices.push_back(Vertex(glm::vec2( 0.0f, -0.5f), glm::vec3(1.0f, 0.0f, 0.0f)));
...
public:
 ...
 private:
    ...
    void initWindow() 
    {
        ...
        this->window = glfwCreateWindow(WIDTH, HEIGHT, "LostPeter - test_vulkan_0019_staging_buffer", nullptr, nullptr);
    ...
    void createInstance()
    {
        ...
        appInfo.pApplicationName = "test_vulkan_0019_staging_buffer";
    ...
    void createCommandBuffers() 
    {
        ...
        for (size_t i = 0; i < this->commandBuffers.size(); i++) 
        {
            ...
            vkCmdBeginRenderPass(commandBuffer, &renderPassInfo, VK_SUBPASS_CONTENTS_INLINE);
                ...
                vkCmdDraw(commandBuffer, static_cast<uint32_t>(this->vertices.size()), 1, 0, 0);
