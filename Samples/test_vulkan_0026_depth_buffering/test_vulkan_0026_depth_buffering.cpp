...
public:
    Application()
    {
        ...
        //Vertex
        this->vertices.push_back(Vertex(glm::vec3(-0.5f, -0.5f,  0.0f), glm::vec3(1.0f, 0.0f, 0.0f), glm::vec2(1.0f, 0.0f)));
        this->vertices.push_back(Vertex(glm::vec3( 0.5f, -0.5f,  0.0f), glm::vec3(0.0f, 1.0f, 0.0f), glm::vec2(0.0f, 0.0f)));
        this->vertices.push_back(Vertex(glm::vec3( 0.5f,  0.5f,  0.0f), glm::vec3(0.0f, 0.0f, 1.0f), glm::vec2(0.0f, 1.0f)));
        this->vertices.push_back(Vertex(glm::vec3(-0.5f,  0.5f,  0.0f), glm::vec3(1.0f, 1.0f, 1.0f), glm::vec2(1.0f, 1.0f)));

        this->vertices.push_back(Vertex(glm::vec3(-0.5f, -0.5f, -0.5f), glm::vec3(1.0f, 0.0f, 0.0f), glm::vec2(1.0f, 0.0f)));
        this->vertices.push_back(Vertex(glm::vec3( 0.5f, -0.5f, -0.5f), glm::vec3(0.0f, 1.0f, 0.0f), glm::vec2(0.0f, 0.0f)));
        this->vertices.push_back(Vertex(glm::vec3( 0.5f,  0.5f, -0.5f), glm::vec3(0.0f, 0.0f, 1.0f), glm::vec2(0.0f, 1.0f)));
        this->vertices.push_back(Vertex(glm::vec3(-0.5f,  0.5f, -0.5f), glm::vec3(1.0f, 1.0f, 1.0f), glm::vec2(1.0f, 1.0f)));
        //Index
...
public:
 ...
 private:
    ...
    void initWindow() 
    {
        ...
        this->window = glfwCreateWindow(WIDTH, HEIGHT, "LostPeter - test_vulkan_0026_depth_buffering", nullptr, nullptr);
    ...
    void createInstance()
    {
        ...
        appInfo.pApplicationName = "test_vulkan_0026_depth_buffering";
    ...
    {
        std::string pathVertexShader = GetAssetsPath() + "Assets/Shader/Vulkan/pos3_tex2_color3_ubo.vert.spv";
        std::vector<char> vertShaderCode = readFile(pathVertexShader);
        std::string pathFragmentShader = GetAssetsPath() + "Assets/Shader/Vulkan/pos3_tex2_color3_ubo.frag.spv";
