...
public:
 ...
 private:
    ...
    void initWindow() 
    {
        ...
        this->window = glfwCreateWindow(WIDTH, HEIGHT, "LostPeter - test_vulkan_0011_render_passes", nullptr, nullptr);
    ...
    void createInstance()
    {
        ...
        appInfo.pApplicationName = "test_vulkan_0011_render_passes";
