...
public:
 ...
 private:
    ...
    void initWindow() 
    {
        ...
        this->window = glfwCreateWindow(WIDTH, HEIGHT, "LostPeter - test_vulkan_0016_swap_chain_recreation", nullptr, nullptr);
    ...
    void createInstance()
    {
        ...
        appInfo.pApplicationName = "test_vulkan_0016_swap_chain_recreation";
