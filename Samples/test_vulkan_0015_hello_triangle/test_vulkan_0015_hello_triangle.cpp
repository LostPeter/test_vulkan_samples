...
public:
 ...
 private:
    ...
    void initWindow() 
    {
        ...
        this->window = glfwCreateWindow(WIDTH, HEIGHT, "LostPeter - test_vulkan_0015_hello_triangle", nullptr, nullptr);
    ...
    void createInstance()
    {
        ...
        appInfo.pApplicationName = "test_vulkan_0015_hello_triangle";
    ...
    void drawFrame() 
    {
        ...
        uint32_t imageIndex;
        vkAcquireNextImageKHR(this->device, this->swapChain, UINT64_MAX, this->imageAvailableSemaphores[this->currentFrame], nullptr, &imageIndex);
    ...
    void cleanup()
    {
        ...
        count = (int)this->swapChainFramebuffers.size();
        for (int i = 0; i < count; i++)
        {
        ...
        count = (int)this->swapChainImageViews.size();
        for (int i = 0; i < count; i++)
        {
