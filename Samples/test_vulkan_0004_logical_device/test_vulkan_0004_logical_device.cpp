...
public:
 ...
 private:
    ...
    void initWindow() 
    {
        ...
        this->window = glfwCreateWindow(WIDTH, HEIGHT, "LostPeter - test_vulkan_0004_logical_device", nullptr, nullptr);
    ...
    void createInstance()
    {
        ...
        appInfo.pApplicationName = "test_vulkan_0004_logical_device";
    ...
    void createLogicalDevice()
    {
        ...
        queueCreateInfo.queueFamilyIndex = this->graphicsIndex;
