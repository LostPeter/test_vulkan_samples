...
public:
 ...
 private:
    ...
    void initWindow() 
    {
        ...
        this->window = glfwCreateWindow(WIDTH, HEIGHT, "LostPeter - test_vulkan_0021_descriptor_layout", nullptr, nullptr);
    ...
    void createInstance()
    {
        ...
        appInfo.pApplicationName = "test_vulkan_0021_descriptor_layout";
    ...
    {
        std::string pathVertexShader = GetAssetsPath() + "Assets/Shader/Vulkan/pos2_color3_ubo.vert.spv";
        std::vector<char> vertShaderCode = readFile(pathVertexShader);
        std::string pathFragmentShader = GetAssetsPath() + "Assets/Shader/Vulkan/pos2_color3_ubo.frag.spv";
